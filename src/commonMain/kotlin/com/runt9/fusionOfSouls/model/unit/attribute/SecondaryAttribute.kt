...
class SecondaryAttributes(primary: PrimaryAttributes) {
    val maxHp = SecondaryAttribute(primary, primary.body, primary.mind) { (body * 1.0) + (mind * 0.5) }
    val baseDamage = SecondaryAttribute(primary, primary.body, primary.instinct) { (body * 0.25) + (instinct * 0.25) }
