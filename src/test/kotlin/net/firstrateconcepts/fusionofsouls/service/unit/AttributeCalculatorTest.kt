...
class AttributeCalculatorTest {
    ...
    fun `Test with various modifiers to everything`(attr: AttributeType, value: Float) {
        ...
        entity.addModifier(ACCURACY, flatModifier = 10f, percentModifier = 50f)
